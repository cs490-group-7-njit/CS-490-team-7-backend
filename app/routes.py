    ...
    try:
        ...
        if new_status == "completed":
            notification = Notification(
                ...
                message=f"Your appointment at {appointment.staff.user.name if appointment.staff and appointment.staff.user else 'the staff member'}'s salon has been completed. You earned {points_earned} loyalty points!", #fixed
            ...
            notification = Notification(
                ...
                message=f"Your appointment at {appointment.staff.user.name if appointment.staff and appointment.staff.user else 'the staff member'}'s salon has been cancelled.",  #fixed
            ...
            notification = Notification(
                ...
                message=f"You missed your appointment at {appointment.staff.user.name if appointment.staff and appointment.staff.user else 'the staff member'}'s salon.", #fixed
                notification_type="appointment_cancelled",
            )
            db.session.add(notification)
